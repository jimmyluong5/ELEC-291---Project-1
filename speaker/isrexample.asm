...
;    half a second.
; b) Generates a 2kHz square wave at pin P2.1 using an ISR for timer 0.
...
; d) Controls the LCD using general purpose pins in ports P0 and P1 
;
$NOLIST
$MODMAX10
$LIST
...
main:
    ...
    ; We use pins P1.7 and P1.1 as outputs also.  Configure accordingly.
    mov P1MOD, #10000010b ; P1.7 and P1.1 are outputs
    mov P2MOD, #10000010b ; P2.1 is output
